...
class HomeH extends Component {
  ...
  sendMessage(e) {
    ...
    if (params.nombre && params.apellidop && params.apellidom && params.municipio && params.email
      ...
      firebaseConf.database().ref('agenda-cita/huejutla').push(params).then(() => {
  ...
  render() {
    ...
    return (
      <div style={{width: '100%', justifyContent: 'center', display: 'flex', zIndex: '100', paddingTop: '100px'}}>
        ...
        <div style={{width: '65%'}}>
          <h1 className="back-title-t">Expedición de Constancia de NO Antecedentes Penales</h1>
          <div className="row">
            <div className="text">
            ...
            <div className="text">
              ...
              <p>Servicios Periciales Huejutla</p>
